...
<div class="row">
    <div class="col-lg-12">
        ...
        if ($products)
        {
                    ...
                    <tbody>
                        ...
                        for ($i = $start; $i < $end; $i++)
                        {
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-success"  id="product-edit" href="index.php?page=edit-product&id=<?php echo $row['id']; ?>&cat_id=<?php echo $row['cat_id']; ?>">Edit</a></td>
                                <td><a class="btn btn-danger" id="product-delete" href="index.php?page=delete-product&id=<?php echo $row['id']; ?>&cat_id=<?php echo $row['cat_id']; ?>">Delete</a></td>
                            </tr>
                            <?php
                        }
                        ?>
            ...
            ?>
        <p>No products available. Please Click on <strong>New Product</strong> button to add products.</p> 
