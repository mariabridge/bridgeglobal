                    ...
                    <tbody>
                        ...
                        for ($i = $start; $i < $end; $i++)
                        {
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-danger category-delete" id="" rel="index.php?page=delete-category&id=<?php echo $row['id']; ?>" href="#">Delete</a></td>
                                <?php 
                                $empty_flag==0;
                                for($e=0; $e<count($empty_prod_cat);$e++){ 

                                    if($empty_prod_cat[$e]==$row['id']) { $empty_flag =1; break; }
                                }
                                    if($empty_flag==0) {
                                ?>
                                <td><a class="btn btn-info" id="category-products" href="index.php?page=new-product&cat_id=<?php echo $row['id']; ?>">Add Products</a></td>
