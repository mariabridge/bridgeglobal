                        ...
                        if (isset($category_info))
                        {
                            if ($category_info['status'] == 1)
                            {
                                ...
                                <label class="radio-inline">
                                    <input name="cat-status" id="cat-status-enabled" value="1" type="radio" checked=""> Enable
                                </label>
                                <label class="radio-inline">
                                    <input name="cat-status" id="cat-status-disabled" value="0" type="radio"> Disable
                                </label>
                                <?php
                            }
                            else
                            {
                                ?>
                                <label class="radio-inline">
                                    <input name="cat-status" id="cat-status-enabled" value="1" type="radio" > Enable
                                </label>
                                <label class="radio-inline">
                                    <input name="cat-status" id="cat-status-disabled" value="0" type="radio" checked=""> Disable
                                </label>
                                <?php
                            }
                        }
