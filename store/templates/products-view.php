...
<div class="col-lg-12">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h1 class="panel-title">Products<?php echo (isset($cat_name) && $cat_name != '') ? '-' . $cat_name : ''; ?></h1>
        </div>
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-lg-9 cat-detail-product" style="display: inline">
                    <div class="row">
                        <?php                        
                            ...
                            {         
                                ...
                                <div class="col-lg-6">
								 <?php  if(!empty($_SESSION['user_id']))
                                                ...
                                                if(in_array($product['id'], $uniquekeys) && $user_role!=1) {   ?>
                                            <a class="<?php echo $class; ?>" style="float: right;margin-top: 10px; margin-right: 5px; color:#82c549;"></a>
                                             <?php } ?>
