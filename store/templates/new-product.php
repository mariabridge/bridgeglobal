...
<div class="form-group">
<label>Price ($)</label>
<input class="form-control" id="product-price" name="product-price" placeholder="" <?php if(isset($product_info)) { echo "value=".$product_info['price']; } ?>  onblur="productFromValid();"/>
...
<!--<div class="form-group">
<label>Download Link Validity (Hours)</label>
...
<?php } ?>
<input type="hidden" name="hid-product-upload"  <?php if(isset($product_info) && !empty($product_info)) ?> value="<?php echo $product_info['download_link'];?>">
</div>
...
<input type="hidden" name="hid-product-image" value="<?php print_r($prod_img); ?>"> 
</div> 
...
<input name="product-status" id="product-status-enabled" value="1" type="radio" <?php echo ($product_info['status'] == 1) ? 'checked=""' : '';  ?>> Enable
</label>
<label class="radio-inline">
<input name="product-status" id="product-status-disabled" value="0" type="radio" <?php echo ($product_info['status'] == 0) ? 'checked=""' : '';  ?>> Disable
</label>
<?php
...
?>
<label class="radio-inline">
<input name="product-status" id="product-status-enabled" value="1" type="radio" checked=""> Enable
</label>
<label class="radio-inline">
<input name="product-status" id="product-status-disabled" value="0" type="radio"> Disable
</label>
<?php
}
?>
...
$(document).ready(function(){
	...
	var editor = CKEDITOR.replace( 'neweditor' );
      ...
      CKEDITOR.instances.neweditor.on('blur', function() {
...
var prodDesc=CKEDITOR.instances.neweditor.getData();
...
if(flag1==true && flag2==true && flag3==true && flag5==true && flag6==true && flag8==true && flag9==true && flag10==true )
flag=true;
else
flag=false;
console.info(flag);
...
var re = /(\.jpg|\.jpeg|\.bmp|\.gif|\.png|\.txt|\.pdf|\.docx|\.zip|\.tgz)$/i;
if(!re.exec(fname))
{
return false;
}
