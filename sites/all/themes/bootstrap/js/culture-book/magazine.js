...
function loadPage(page, pageElement) {
	...
	img.attr('src', 'sites/all/themes/bootstrap/js/culture-book/pages/' +  page + '.jpg');
...
function loadRegions(page, element) {
	...
	jQuery.getJSON('sites/all/themes/bootstrap/js/culture-book/pages/'+page+'-regions.json').
		done(function(data) {
...
function loadLargePage(page, pageElement) {
	...
	img.attr('src', 'sites/all/themes/bootstrap/js/culture-book/pages/' +  page + '-large.jpg');
}
...
function setPreview(view) {
	...
	var previewWidth = 112,
		previewHeight = 73,
		previewSrc = 'sites/all/themes/bootstrap/js/culture-book/pages/preview.jpg',
