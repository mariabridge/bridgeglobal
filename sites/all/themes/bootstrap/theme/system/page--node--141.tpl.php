      ...
      <div class="header">
        <div class="mainHeader container">
          <div class="row">
            ...
            <div class="main-nav tb-megamenu">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <?php print render($page['home_client_cases']); ?>
        <button class="blue-button button btn-3 btn-3e client-view-more"><a href="javascript:void(0);">View More</a> <i class="fa fa-chevron-right"></i></button>
      </div>
...
<section class="wrapper footer-section">
    ...
    <div class="copy">
      <div class="container copy-right">
        <div class="col-md-12" style="text-align:center;"><?php echo "Copyright " . date('Y') . " All rights reserved Bridge Global." ?></div>
        <!--  <div class="col-md-4">
         <div class="social-media">
            <?php //print render($page['footer_social_media']); ?>
          </div> 
