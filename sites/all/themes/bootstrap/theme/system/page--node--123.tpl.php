      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-8 team-works">
            <p>
              <b>Number of Projects completed:</b> 3+<br>
            ...
            <div class="col-md-12">
              <div class="row">
                <div class="col-sm-3 col-md-5">
                  <img src="<?php echo $base_url;?>/sites/default/files/staffing-teams/magento-team/novashop.jpg" alt="Novashops">
                </div>
                <div class="col-sm-9 col-md-7">
                  ...
                  <p>This is a multi store online shopping cart customized from magento. The websites focus on selling health products which helps persons to acquire a fit body. The blog, forum, varnish cache and onestepcheckout make it a perfect shopping cart.We have different stores integrated in this magento installation which are listed below:
                    <ul>
                      <li>https://www.novashops.de</li>
                      <li>http://www.proteine-dieet.eu/shop</li>
                      <li>http://forum.novashops.com</li>
                      <li>http://www.novashops.com/dieet</li>
                    </ul>
                  </p>
                  <h3>Features:</h3>
                  <p>
...
jQuery(document).ready(function(){
  ...
  jQuery(".discuss-team").click(function(){
    ...
    jQuery(".discuss-team-popup, .popupWrapper").fadeIn(500);
  ...
  jQuery(".close-box-inner-page a, .popup-close-btn").click(function(){
    jQuery(".discuss-team-popup, .popupWrapper").fadeOut(500);
