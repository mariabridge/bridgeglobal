        ...
        <div class="container">
            <div class="banner">
                <div class="banner-top">
                    Every <span class="strong">IT</span> Problem <br />
                    ...
                    foreach ($nodes as $key => $value ){
                       ...
                       // $testimonials_array[$value->vid]['field_testimonial_company_logo']  = $value->field_testimonial_company_logo['und'][0]['value'];
                        ...
                        <div class="testimonial-box box-<?php echo $level;?>">
                            <a class="testimonial-tooltip testimonial-<?php echo $color?>" href="#">
                                ...
                                <div class="testimonial-name">
                                    <?php echo $testimonials_array[$value->vid]['field_testimonial_client_name']; ?>
                                    <span><?php echo $company[1]; ?></span>
                                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="popular-list-box">
                    <img src="<?php echo $base_url; ?>/sites/all/themes/bootstrap/images/culture-book.jpg" alt="culture book" />
                    <h3>Culture Book</h3>
                    <p>Some descrtiption will be here  descrsome descrtiption will be  and or not here it will be good ...</p>
                    <a href="#" class="listing-next"><span><img src="<?php echo $base_url; ?>/sites/all/themes/bootstrap/images/listing-arrow.png" alt="next arrow" /></a></span>
                </div>
            </div>
            <div class="col-md-3">
                <div class="popular-list-box">
                    <img src="<?php echo $base_url; ?>/sites/all/themes/bootstrap/images/recruitment.jpg" alt="Recruitment"  />
            ...
            <div class="col-md-3">
                <div class="popular-list-box">
                    <img src="<?php echo $base_url; ?>/sites/all/themes/bootstrap/images/delivery-models.jpg" alt="Delivery models"  />
            ...
            <div class="col-md-3">
                <div class="popular-list-box">
                    <img src="<?php echo $base_url; ?>/sites/all/themes/bootstrap/images/agile.jpg" alt="Agile" />
                    <h3>Agile Technology</h3>
                    <p>Some descrtiption will be here  descrsome descrtiption will be  and or not here it will be good ...</p>
                    <a href="#" class="listing-next"><span><img src="<?php echo $base_url; ?>/sites/all/themes/bootstrap/images/listing-arrow.png" alt="next arrow" /></a></span>
                </div>
            </div>
...
<div class="download-ebook video-popup">
...
<script>
   ...
   jQuery(document).ready(function () {
    ...
    console.log('frhdfr'+jQuery(this).scrollTop());
    if (jQuery(this).scrollTop()>0) {
       jQuery('.clientele').animate({"top":"-30px"});
    }
    if (jQuery(this).scrollTop()==0) {
       jQuery('.clientele').css("top","0px");
    }
});  
   });
</script>
