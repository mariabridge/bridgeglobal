...
<?php foreach ($nodes as $key => $value ){
        echo "<br/>company logo===".$news_and_events_array[$value->vid]['field_testimonial_company_logo']  = $value->field_testimonial_company_logo['und'][0]['value'];
        echo "<br/>company name===".$news_and_events_array[$value->vid]['field_testimonial_company_name']  = $value->field_testimonial_company_name['und'][0]['value'];
        echo "<br/>client name===".$news_and_events_array[$value->vid]['field_testimonial_client_name']  = $value->field_testimonial_client_name['und'][0]['value'];
        if( isset( $value->field_testimonial_client_image['und'][0]['filename'] ) && ( $value->field_testimonial_client_image['und'][0]['filename'] != '' ) ){
          $news_and_events_array[$value->vid]['field_testimonial_client_image'] = $base_url.'/sites/default/files/testimonial_client_image/'.$value->field_testimonial_client_image['und'][0]['filename'];
        }else{
        $news_and_events_array[$value->vid]['field_testimonial_client_image'] = '';
        }
        echo "<img src='".$news_and_events_array[$value->vid]['field_testimonial_client_image']."'/>";
        echo "<br/>testimonial content===".$news_and_events_array[$value->vid]['field_testimonial_content'] = $value->field_testimonial_content['und'][0]['value'];
       }?>
