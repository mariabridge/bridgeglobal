								...
								<div class="developer-repeat" id='developer-<?php echo $preview['id'];?>' >
									<div class="row">
										...
										<div class="col-xs-8 col-md-10 dev-details">
											<h1><a class="view-details" href="http://bridge-staffing.com/developer?id=<?php echo $value;?>"><?php echo $preview['name'];?></a></h1>
											...
											<p class="skillset">
												...
												<span class="more-skill">
													...
													<a class="view-details" href="http://bridge-staffing.com/developer?id=<?php echo $value;?>">Full profile</a>
												</span>
											</p>
											<div class="clearfix"></div>
...
<script>
	jQuery(document).ready(function(){
	 ...
	 jQuery('.close-checkout a, .popup-close-btn').click(function(){
	 ...
	 var developer_checkout = function (){
	 	...
	 	setTimeout(function(){
	 		window.open("<?php echo $base_url;?>/pick-my-team","_self");
	 	},1000);
