...
<?php //print ('Your Name' . ':') . ($submission['data'][1]['value'][0]); ?>


<?php print ('Your Name') .':'.($submission->data[1]['value'][0]).("\n");?>
<?php print ('Your Email') .':'.($submission->data[2]['value'][0]).("\n");?>
<?php if($submission->data[3]['value'][0]=="Yes"){
  print ('Need Assistance') .':'.($submission->data[3]['value'][0]).("\n");
  }?>
<?php if($submission->data[4]['value'][0]!="Your Phone"){
  print ('Your Phone') .':'.($submission->data[4]['value'][0]).("\n");
}?>
