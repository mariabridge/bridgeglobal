...
jqCompleteDeliveryModels(document).ready(function(){
	...
	jqCompleteDeliveryModels('#complete-delivery-model-form').submit(function(){
		if(jqCompleteDeliveryModels('#complete-delivery-model-name').val() == 'Your Name' || jqCompleteDeliveryModels.trim( jqCompleteDeliveryModels('#complete-delivery-model-name').val() ) == '') {
			...
			return false;
		}if(jqCompleteDeliveryModels('#complete-delivery-model-email').val() == 'Your Email' || jqCompleteDeliveryModels.trim( jqCompleteDeliveryModels('#complete-delivery-model-email').val() ) == ''  ) {
...
jqResourceTeamModels(document).ready(function(){
	...
	jqResourceTeamModels('#resource-team-model-form').submit(function(){
		if(jqResourceTeamModels('#resource-team-model-name').val() == 'Your Name' || jqResourceTeamModels.trim( jqResourceTeamModels('#resource-team-model-name').val() ) == '') {
			...
			return false;
		}if(jqResourceTeamModels('#resource-team-model-email').val() == 'Your Email' || jqResourceTeamModels.trim( jqResourceTeamModels('#resource-team-model-email').val() ) == ''  ) {
...
jqResourceModels(document).ready(function(){
	...
	jqResourceModels('#resource-model-form').submit(function(){
		if(jqResourceModels('#resource-model-name').val() == 'Your Name' || jqResourceModels.trim( jqResourceModels('#resource-model-name').val() ) == '') {
			...
			return false;
		}if(jqResourceModels('#resource-model-email').val() == 'Your Email' || jqResourceModels.trim( jqResourceModels('#resource-model-email').val() ) == ''  ) {
