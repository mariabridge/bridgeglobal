...
if( isset( $_POST ) ){
	...
	if( ( $your_name != '' ) && ( $your_email != '' ) && ( $your_model_image != '' ) ){
		...
		$toArray['sumesh.kv@bridge-india.in']	= 'Admin';
		$admin_message_body						= 'Hi Admin,<br/><br/>'.$your_name.' chosen to discuss the delivery model - '.$subject.' Model design is given below <br> <img alt="PHPMailer" src="cid:bridge-attach">';
